...
class PostRoutes {
  ...
  public routes(): Router {
    ...
    this.router.put('/post/:id', authMiddleware.checkAuthentication, Update.prototype.posts);
    this.router.put('/post/image/:id', authMiddleware.checkAuthentication, Update.prototype.postWithImage);

    this.router.delete('/post/:id', authMiddleware.checkAuthentication, Delete.prototype.post);
